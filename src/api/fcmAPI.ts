...
// 서버 URL 가져오기
const USER_SERVER_URL = import.meta.env.VITE_USER_SERVER_URL || "https://tripwhiz.shop";
const STORE_SERVER_URL = import.meta.env.VITE_STORE_SERVER_URL || "https://tripwhiz.shop";
